 ...
 * ---
 * Solution:
 * When iterating through bits in the 64-bit number:
 * - having an even number of 1s will result in parity 0 (for each 1 there is a corresponding 1 pair resulting in 0 parity)
 * - having an odd number of 1s will result in parity 1 (there is one 1 which doesn't have a corresponding 1 pair resulting in 1 parity)
 * ---
